...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-gray-900 border-b border-gray-700 p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          {roomId && (
            <span className="bg-gray-800 text-gray-300 px-3 py-1 rounded-full text-sm border border-gray-600">
          ...
          {userIdentity && (
            <div className="flex items-center space-x-3 bg-gray-800 px-3 py-1.5 rounded-lg border border-gray-700">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-green-400 leading-none">Online</span>
              </div>
            </div>
          )}
